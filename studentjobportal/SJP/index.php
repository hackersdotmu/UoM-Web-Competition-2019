	...
	<div class="sidebar-box">
		...
		<div class="sidebar-box-bottom">
			...
			<div id="register-form" style="display:none;">
				<a href="registration.php" title="Create Jobseeker Account">REGISTER AS JOBSEEKER</a><br><br>
				<a href="registration.php" title="Create Employer Account">REGISTER AS EMPLOYER</a>
			</div>
			</div';
		}
			?>
