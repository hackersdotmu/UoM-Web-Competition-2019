...
<div class="container-fluid bg body" id="formregister">
  ...
  <form method="post" action="register.php" name="register" id="registerform">
 	...
 	<div class="form-group">
  	...
  	<div class="password col-lg-12"><input type="password" class="form-control" name="password"  placeholder="Enter password">
  	</td></tr></div>
