...
<div class="container">
  <header>
    ...
    <nav class="secondary_header1" id="menu1">
      <ul>
        <li><a href="http://localhost/webcup/memberseng.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Engineering</a></li>
        <li><a href="http://localhost/webcup/memberslaw.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Law</a></li>
        <li><a href="http://localhost/webcup/membersmedicine.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Medicine</a></li>
        <li><a href="http://localhost/webcup/membershospitality.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Hospitality</a></li>
        <li><a href="http://localhost/webcup/membersfinance.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Finance</a></li>
        <li><a href="http://localhost/webcup/membersaccounting.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Accounting</a></li>
...
$sql="SELECT username,coursename FROM users WHERE fieldOfStudy ='finance'";
