...
<div class="container">
  <header>
    ...
    <nav class="secondary_header" id="menu">
      ...
      <ul>
        <li>
       <a href="http://localhost/webcup/home.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Home</a>
        </li>
		...
		<li>
       <a href="http://localhost/webcup/comment/index.php" style="text-decoration: none;cursor:pointer; color: inherit;" >Project Forum</a>
        </li>
        
         <?php  if (isset($_SESSION['username'])) : ?>
         <p>Welcome <strong><?php echo $_SESSION['username']; ?></strong></p>
    	<p> <a href="index.php?logout='username'" style="color: black;">Log out</a> </p>
    	
    	
        <li><a href="http://192.168.64.2/register/login.php" style="text-decoration: none;cursor:pointer; color: inherit;">Login/Register</a></li>
